    ...
    Plugin.prototype = {
        ...
        _clickEvents: function () {
            ...
            self.widget.on(clickEvent, '.jarviswidget-fullscreen-btn', function (e) {
                ...
                var hasnooverflow = $(this).data('hasnooverflow');

                if(typeof hasnooverflow === 'undefined') {
                    hasnooverflow = !!$('.nooverflow').length;
                    $(this).data('hasnooverflow', hasnooverflow);
                }
                /**
                 * Run function for the indicator image.
                 **/
                ...
                if ($('#jarviswidget-fullscreen-mode')
                    ...
                    $(document).trigger('unfullscreen.widget_header_fullscreen');
                    ...
                    $(document).trigger('fullscreen.widget_header_fullscreen');
                }
