...
AjaxBootstrapSelectList.prototype.setTitle = function (title) {
    if (!this.plugin.request) {
        ...
        this.plugin.selectpicker.options.selectedTextFormat = 'value';
...
$.fn.ajaxSelectPicker.locale.en = $.fn.ajaxSelectPicker.locale['zh-CN'];
