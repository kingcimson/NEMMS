...
<body class="easyui-layout" id="body-layout">
	...
	<div id="center" data-options="region:'center'">
		<div class="toolbar">
			<a id="btn-item" class="easyui-linkbutton" data-options="iconCls:'icon-item',plain:true">获取参数列表</a> 
			<a id="btn-search" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">查询全部</a> 
			...
			<center>
				<table cellpadding="5" style="margin: 30px auto" class="form-table">
					...
					<tr>
						...
						<td>站点顺序:</td>
						<td><input class="easyui-textbox" type="text" id="sequence" name="sequence" data-options="required:true" style="width: 115px"></input></td>
					</tr>
					<tr>
						<td>设备类型:</td>
						<td><select class="easyui-combobox" id="deviceType" name="deviceType" data-options="valueField:'value',textField:'name'" style="width: 148px"></select></td>
						<td>AP协议类型:</td>
						<td><select class="easyui-combobox" id="apProtocol" name="apProtocol" data-options="valueField:'value',textField:'name'" style="width: 115px"></select></td>
					</tr>
					<tr>
						<td>MCP协议类型:</td>
						<td><select class="easyui-combobox" id="mcpProtocol" name="mcpProtocol" data-options="valueField:'value',textField:'name'" style="width: 148px"></select></td>
						<td>通讯协议类型:</td>
						<td><select class="easyui-combobox" id="protocol" name="protocol" data-options="valueField:'value',textField:'name'" style="width: 115px"></select></td>
					</tr>
					<tr>
						<td>UDP协议IP地址:</td>
						<td><input class="easyui-textbox" type="text" id="ipAddr" name="ipAddr" data-options="required:true"></input></td>
						<td>UDP协议端口:</td>
						<td><input class="easyui-textbox" type="text" id="port" name="port" data-options="required:true" style="width: 115px"></input></td>
					</tr>
					<tr>
						<td>设备厂商:</td>
	...
	<div id="edit-site-dlg" title="编辑站点">
		...
		<center>
				<table cellpadding="5" style="margin: 30px auto" class="form-table">
					<tr>
						<td>站点名称:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" id="edit-name" name="name" data-options="required:true" style="width: 380px"></input></td>
					</tr>
					<tr>
						<td>站点编号:</td>
						<td><input class="easyui-textbox" type="text" id="edit-uid" name="uid" data-options="required:true"></input></td>
						<td>站点顺序:</td>
						<td><input class="easyui-textbox" type="text" id="edit-sequence" name="sequence" data-options="required:true" style="width: 115px"></input></td>
					</tr>
					<tr>
						<td>设备类型:</td>
						<td><select class="easyui-combobox" id="edit-deviceType" name="deviceType" data-options="valueField:'value',textField:'name'" style="width: 148px"></select></td>
						<td>AP协议类型:</td>
						<td><select class="easyui-combobox" id="edit-apProtocol" name="apProtocol" data-options="valueField:'value',textField:'name'" style="width: 115px"></select></td>
					</tr>
					<tr>
						<td>MCP协议类型:</td>
						<td><select class="easyui-combobox" id="edit-mcpProtocol" name="mcpProtocol" data-options="valueField:'value',textField:'name'" style="width: 148px"></select></td>
						<td>通讯协议类型:</td>
						<td><select class="easyui-combobox" id="edit-protocol" name="protocol" data-options="valueField:'value',textField:'name'" style="width: 115px"></select></td>
					</tr>
					<tr>
						<td>UDP协议IP地址:</td>
						<td><input class="easyui-textbox" type="text" id="edit-ipAddr" name="ipAddr" data-options="required:true"></input></td>
						<td>UDP协议端口:</td>
						<td><input class="easyui-textbox" type="text" id="edit-port" name="port" data-options="required:true" style="width: 115px"></input></td>
					</tr>
					<tr>
						<td>设备厂商:</td>
					...
					<tr>
						<td>站点备注:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" id="edit-comment" name="comment" style="width: 380px"></input>
	...
	<div id="add-device-dlg" title="增加设备">
		...
		<center>
				<table cellpadding="5" style="margin: 30px auto" class="form-table">
					<tr>
						<td>设备名称:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" id="device-name" name="name" data-options="required:true" style="width: 380px"></input></td>
					</tr>
					<tr>
						<td>设备编号:</td>
						<td><input class="easyui-textbox" type="text" id="device-uid" name="uid" data-options="required:true"></input></td>
						<td>设备顺序:</td>
						<td><input class="easyui-textbox" type="text" id="device-sequence" name="sequence" data-options="required:true" style="width: 138px"></input></td>
					</tr>
					<tr>
						<td>设备备注:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" id="device-comment" name="comment" style="width: 380px"></input>
						<input type="hidden" name="pid" id="device-pid"></input>
						<input type="hidden" name="flag" id="device-flag" value="1"></input>
						</td>
					</tr>
				</table>
			</center>
		...
		<form id="edit-device-form" name="edit-device-form" method="post">
			<center>
				<table cellpadding="5" style="margin: 30px auto" class="form-table">
					<tr>
						<td>设备名称:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" id="edit-device-name" name="name" data-options="required:true" style="width: 380px"></input></td>
					</tr>
					<tr>
						<td>设备编号:</td>
						<td><input class="easyui-textbox" type="text" id="edit-device-uid" name="uid" data-options="required:true"></input></td>
						<td>设备顺序:</td>
						<td><input class="easyui-textbox" type="text" id="edit-device-sequence" name="sequence" data-options="required:true" style="width: 138px"></input></td>
					</tr>
					<tr>
						<td>设备备注:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" id="edit-device-comment" name="comment" style="width: 380px"></input>
						 <input	type="hidden" name="id" id="edit-device-id"></input></td>
					</tr>
				</table>
			</center>
		</form>
