...
<body class="fixed-header fixed-ribbon fixed-navigation smart-style-3">
	<!-- POSSIBLE CLASSES: minified, fixed-ribbon, fixed-header, fixed-width
			 You can also add different skin classes such as "smart-skin-1", "smart-skin-3" etc...-->
	...
	<div id="logo-group">
		...
		<span id="logo"> <img src="<%=request.getContextPath()%>/assets/img/logo-white.png" alt="裕源大通网元监控与管理系统">
		</span>
