...
<script src="<%=request.getContextPath()%>/assets/modules/device/js/param.js?v=<%=Math.random()%>"></script>
</head>
		...
		<form id="add-form" name="add-form" method="post">
			<center>
				<table cellpadding="5" style="margin: 30px auto" class="form-table">
					...
					<tr>
						<td>参数标识:</td>
						<td><input class="easyui-textbox" type="text" name="uid" id="uid" value="0x" data-options="required:true"></input></td>
						<td>MCP协议:</td>
		...
		<form id="edit-form" name="edit-form" method="post">
			<center>
				<table cellpadding="5" style="margin: 30px auto" class="form-table">
					...
					<tr>
						<td>参数标识:</td>
						<td><input class="easyui-textbox" type="text" name="uid" id="edit-uid" data-options="required:true"></input></td>
						<td>MCP协议:</td>
