		...
		<form id="add-form" name="add-form" method="post">
			<center>
				...
				<table cellpadding="5" style="margin: 30px auto" class="form-table">
                   ...
                   <tr>
						<td>角色名称:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" name="role_name" id="role_name" data-options="required:true" style="width: 380px"></input></td>
					</tr>
					<tr>
						<td>角色代号:</td>
						<td><input class="easyui-textbox" type="text" name="role_code" id="role_code" value="0x" data-options="required:true"></input></td>
						<td>系统角色:</td>
						<td>
                        <select class="easyui-combobox" id="isSystem" name="isSystem" data-options="valueField:'value',textField:'name'" style="width: 148px">
                   ...
                   <tr>
						<td>状态:</td>
						<td >
                            <select class="easyui-combobox" id="status" name="status" data-options="valueField:'value',textField:'name'" style="width: 148px">
                        <option selected="selected" value="1">启用</option>
						<option value="0">禁用</option>
                        </select>
                        </td>
                        <td>排序：</td>
                        <td><input class="easyui-textbox" type="text" name="role_sequence" id="role_sequence" value="0x" data-options="required:true"></input></td>
					</tr>
					<tr>
						<td>登陆密码:</td>
					...
					<tr>
						<td>权限:</td>
						<td colspan="3">
                          <label class="checkbox"> <input type="checkbox" name="chkAll" id="chkAll"> <i></i>所有权限</label>
					...
					<tr>
						<td>可查看设备参数属性:</td>
						<td colspan="3" class="check01">
                         <label class="checkbox">全选 <input type="checkbox" name="checkAllDeviceParamProps" id="checkAllDeviceParamProps"><i></i></label><br/>
														...
														<label class="checkbox">读写属性<input class="checkbox-item" type="checkbox" name="deviceParamProps" id="prop_mode" value="mode"><i></i></label><br/>
														...
														<label class="checkbox">值数据类型<input class="checkbox-item" type="checkbox" name="deviceParamProps" id="prop_value_type" value="value_type"><i></i></label><br/>
														...
														<label class="checkbox">值数据最大长度<input class="checkbox-item" type="checkbox" name="deviceParamProps" id="prop_value_max_len" value="value_max_len"><i></i></label><br/>
					...
					<tr>
						<td>描述:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" name="role_comment" id="role_comment" data-options="required:true" style="width: 380px"></input></td>
					</tr>
					...
					<tr>
						...
						<td colspan="3" class="check01">
                         <label class="checkbox">全选 <input type="checkbox" name="checkAllDeviceParamProps" id="checkAllDeviceParamProps"><i></i></label><br/>
														...
														<label class="checkbox">参数最小值<input class="checkbox-item" type="checkbox" name="deviceParamProps" id="prop_min_value" value="min_value"><i></i></label>
														<label class="checkbox">参数最大值<input class="checkbox-item" type="checkbox" name="deviceParamProps" id="prop_max_value" value="max_value"><i></i></label>
														<label class="checkbox">告警级别<input class="checkbox-item" type="checkbox" name="deviceParamProps" id="prop_warn_level" value="warn_level"><i></i></label>                        </td>
					</tr>
					<tr>
						<td>描述:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" name="role_comment" id="role_comment" data-options="required:true" style="width: 380px"></input></td>
