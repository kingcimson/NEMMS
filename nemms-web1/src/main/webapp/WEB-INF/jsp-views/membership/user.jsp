...
<body class="easyui-layout">
	...
	<div id="tb" style="padding: 2px 5px;">
		账号 <select class="easyui-combobox" panelHeight="auto" style="width: 100px">
		...
		<input name="" type="text">
			<a href="#" class="easyui-linkbutton" iconCls="icon-search">搜索</a>&nbsp;<a href="#" onclick="$('#w').window('open')" class="easyui-linkbutton"
		...
		<form id="ff" method="post">
			<center>
				<table cellpadding="5" style="margin: 30px auto" class="table1">
					...
					<tr>
						<td>状态:</td>
						<td colspan="3"><select class="easyui-combobox" name="language">
					...
					<tr>
						<td>所属角色:</td>
						<td colspan="3"><input name="" type="checkbox" value="">
								超级管理员 <input name="" type="checkbox" value="">
									超级管理员 <input name="" type="checkbox" value="">超级管理员 </td>
					</tr>
					<tr>
						<td>备注:</td>
						<td colspan="3"><input class="easyui-textbox" type="text" name="name" data-options="required:true" style="width: 380px"></input></td>
