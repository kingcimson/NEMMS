package com.wellheadstone.nemms.data.jdbc;
...
public interface IBaseDao<T> {
	 ...
	 *
	 * @param condition
	 *            删除记录的条件语句,不需要带SQL语句的Where关键字
	 * @param args
	 *            SQL参数对应值的集合,如果条件字符串中含有参数标记,则必须设置该数组的值
	 * @return 返回影响记录的行数,-1表示操作失败,大于-1表示成功
	 */
	 ...
	 *            不带Where的更新条件
	 * @param args
	 *            SQL参数对应值的集合,该数组的值必须与columnNames按顺序对应
	 * @param columnNames
	 *            指定数据库表中需要更新的列名集合
	 * @return 返回影响记录的行数,-1表示操作失败,大于-1表示成功
	 */
	 ...
	 *            更新的对象集合
	 * @param condition
	 *            指定的条件,不要求带SQL语句Where关键字的条件
	 * @param cndColumnNames
	 *            条件中所命名用的列名
	 * @param columnNames
	 *            指定数据库表中需要更新的列名集合
	 * @return 返回影响记录的行数,-1表示操作失败,大于-1表示成功
	 ...
	 *            指定的条件,不要求带SQL语句Where关键字的条件
	 * @param sortItem
	 *            排序字段名称，不要求带ORDER BY关键字,只要指定排序字段名称即可
	 * @param sortType
	 *            SQL语句排序类型
	 * @param args
	 *            SQL参数对应值的集合,如果条件字符串中含有参数标记,则必须设置该数组的值
	 ...
	 *
	 * @param condition
	 *            要求带SQL语句Where关键字的条件，如果不带Where关键字该方法将对表中所有记录执行操作
	 * @param args
	 *            SQL参数对应值的集合,如果条件字符串中含有参数标记,则必须设置该数组的值
	 * @return 指定条件的记录总数
	 */
